...
from sqlalchemy import String, BigInteger, Boolean, DateTime, Float, ForeignKey, JSON, UniqueConstraint, Uuid, CheckConstraint
...
class EventReaction(Base):
    ...
    __table_args__ = (UniqueConstraint('user_id', 'event_id'), CheckConstraint("reaction IN ('like', 'dislike')"))
    id: Mapped[uuid.UUID] = mapped_column(Uuid, primary_key=True, default=uuid.uuid4)
